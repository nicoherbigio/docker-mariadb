# Building instructions for the MariaDB Docker image
...
```
# Build the Docker image
docker build --no-cache --pull --tag nicoherbigde/mariadb:12.1-noble 12.1/ubuntu/default/
```
...
docker push nicoherbigde/mariadb:12.1-noble
```
